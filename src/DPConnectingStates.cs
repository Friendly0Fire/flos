...
namespace FLServer
{
    ...
    {
        private static DPCLoginState instance;
        ...
        public void RxMsgFromClient(Player.Player player, byte[] msg)
        {
            ...
            else if (msg[0] == 0x01 && msg.Length == 75)
            {
                ...
                var accs = CharacterDB.Database.GetAccount(accountid);
    ...
    {
        private static DPCSelectingCharacterState instance;
        ...
        public void RxMsgFromClient(Player.Player player, byte[] msg)
        {
            ...
            else if (msg[0] == 0x06 && msg[1] == 0x03)
            {
                ...
                var acct = CharacterDB.Database.GetOneAccount(player.AccountID, charfilename);
            ...
            else if (msg[0] == 0x39 && msg[1] == 0x03)
            {
                ...
                if (CharacterDB.Database.GetAccount(@"CharName", charname) != null) return;

                CharacterDB.Database.AddAccount(player.AccountID, charname);
            ...
            else if (msg[0] == 0x3a && msg[1] == 0x03)
            {
                ...
                CharacterDB.Database.DelAccount(player.AccountID,charfile);
        ...
        {
            if (instance == null)
                instance = new DPCSelectingCharacterState();
            return instance;
        }
    }
}